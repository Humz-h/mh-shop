  ...
  return (
    <div className="flex items-center border-t border-gray-3 py-5 px-7.5 hover:bg-gray-1/50 transition-colors ease-out duration-200">
      <div className="min-w-[400px]">
        <div className="flex items-center justify-between gap-5">
          <div className="w-full flex items-center gap-5.5">
            <div className="flex items-center justify-center rounded-lg bg-gray-2 max-w-[80px] w-full h-20 overflow-hidden">
              <Image 
                width={80} 
                height={80} 
      ...
      <div className="min-w-[180px]">
        <p className="text-dark font-medium">{formatCurrency(item.discountedPrice, "VND")}</p>
        {item.price > item.discountedPrice && (
          <p className="text-dark-4 line-through text-sm mt-1">
      ...
      <div className="min-w-[275px]">
        <div className="w-max flex items-center rounded-md border border-gray-3">
          <button
            ...
            aria-label="button for decrease quantity"
            className="flex items-center justify-center w-11.5 h-11.5 ease-out duration-200 hover:text-blue hover:bg-gray-1"
            disabled={quantity <= 1}
          >
            <svg
          ...
          <button
            ...
            aria-label="button for increase quantity"
            className="flex items-center justify-center w-11.5 h-11.5 ease-out duration-200 hover:text-blue hover:bg-gray-1"
          >
            <svg
              className="fill-current"
      ...
      <div className="min-w-[200px]">
        <p className="text-dark font-semibold">{formatCurrency(item.discountedPrice * quantity, "VND")}</p>
      </div>
      ...
      <div className="min-w-[50px] flex justify-end">
        <button
          ...
          className="flex items-center justify-center rounded-lg max-w-[38px] w-full h-9.5 bg-gray-2 border border-gray-3 text-dark ease-out duration-200 hover:bg-red-50 hover:border-red-300 hover:text-red-600"
        >
          <svg
            className="fill-current"
            width="22"
