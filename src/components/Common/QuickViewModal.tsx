              ...
              <div className="flex gap-5">
                ...
                <div className="relative z-1 overflow-hidden flex items-center justify-center w-full sm:min-h-[508px] bg-gray-1 rounded-lg border border-gray-3">
                  <div>
                    ...
                    <Image
                      src={product?.imgs?.previews?.[activePreview] || "/images/products/default.png"}
            ...
            <div className="max-w-[445px] w-full">
                ...
                <div>
                  ...
                  <span className="flex items-center gap-2">
                    <span className="font-semibold text-dark text-xl xl:text-heading-4">
                      {formatCurrency(product.discountedPrice, "VND")}
                    </span>
              ...
              <div className="flex flex-wrap items-center gap-4">
                <button
                  ...
                  className={`inline-flex items-center justify-center font-bold text-base text-white bg-blue-600 border-[3px] border-blue-700 py-3 px-7 rounded-md ease-out duration-200 hover:bg-blue-700 hover:border-blue-800 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed
                  `}
                >
                  Thêm vào giỏ hàng
                </button>
