                ...
                <div className="bg-white shadow-1 rounded-[10px]">
                  ...
                  <div className="pt-2.5 pb-8.5 px-4 sm:px-8.5">
                    ...
                    <div className="flex items-center justify-between py-5 border-b border-gray-3">
                      ...
                      <div>
                        <p className="text-dark text-right">{formatCurrency(899000, "VND")}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between py-5 border-b border-gray-3">
                      ...
                      <div>
                        <p className="text-dark text-right">{formatCurrency(129000, "VND")}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between py-5 border-b border-gray-3">
                      ...
                      <div>
                        <p className="text-dark text-right">{formatCurrency(29000, "VND")}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between py-5 border-b border-gray-3">
                      ...
                      <div>
                        <p className="text-dark text-right">{formatCurrency(15000, "VND")}</p>
                      </div>
                    </div>
