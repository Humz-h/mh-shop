      ...
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0 pb-15 border-b border-gray-3">
        <div className="swiper categories-carousel common-carousel">
          ...
          <div className="relative">
            ...
            <button 
              onClick={handlePrev} 
              className="swiper-button-prev !absolute left-0 top-1/2 -translate-y-1/2 z-10 -translate-x-1/2"
            >
                <svg
            ...
            <button 
              onClick={handleNext} 
              className="swiper-button-next !absolute right-0 top-1/2 -translate-y-1/2 z-10 translate-x-1/2"
            >
                <svg
                  className="fill-current"
                  width="24"
