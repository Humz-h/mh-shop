        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li>
                <a
                  href="https://zalo.me/0961876281"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-4.5 ease-out duration-200 hover:text-blue"
                >
                  <Image
                    src="https://logowik.com/content/uploads/images/t_zalo-video-call-new-20219013.jpg"
                    alt="Zalo"
                    width={24}
                    height={24}
            ...
            <div className="flex items-center gap-4 mt-7.5">
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Zalo"
                className="flex ease-out duration-200 hover:opacity-80"
              >
                <Image
                  src="https://logowik.com/content/uploads/images/t_zalo-video-call-new-20219013.jpg"
                  alt="Zalo"
