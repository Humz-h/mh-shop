      ...
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-white shadow-1 min-h-[270px] mb-4">
        ...
        <div className="absolute left-0 bottom-0 translate-y-full w-full flex items-center justify-center gap-2.5 pb-5 ease-linear duration-200 group-hover:translate-y-0 z-10">
          <button
            ...
            className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-dark bg-white hover:text-blue cursor-pointer relative z-20"
            type="button"
          >
            <svg
          ...
          <button
            ...
            className="inline-flex items-center justify-center font-bold text-sm py-[7px] px-5 rounded-[5px] bg-blue-600 text-white border-[3px] border-blue-700 ease-out duration-200 hover:bg-blue-700 hover:border-blue-800 shadow-lg"
          >
            Thêm vào giỏ hàng
          </button>
